  ...
  return (
    <section className="px-5 pb-5 sm:px-8">
      <div className="relative mx-auto flex max-w-[1280px] flex-col items-start justify-between gap-7 overflow-hidden rounded-xl bg-[var(--navy)] px-7 py-8 text-white sm:flex-row sm:items-center sm:px-12 sm:py-10">
        ...
        <Link to="/book-consultation" className="relative inline-flex items-center gap-3 rounded-sm bg-[var(--gold)] px-6 py-3 text-xs font-bold uppercase tracking-[0.1em] text-white transition hover:bg-[var(--gold-light)]">Book a consultation <ArrowRight size={14} /></Link>
      </div>
    </section>
  );
}
